...
public class SharingController {
    ...
    ResponseEntity<SharedPropertyDTO> getSharedProperties(@PathVariable Integer shareWithId, @RequestBody SharedPropertyDTO sharedPropertyDTO) {
        ...
        SharedProperty saved = sharingService.save(sharedProperty);
